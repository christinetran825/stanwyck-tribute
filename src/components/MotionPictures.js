      ...
      <section id="motion-pictures">
        ...
        <div className="story">
          <article className="precode">
            <h4 className="article-title">Pre-code</h4>
          ...
          <article className="movie-highlights">
            <h4 className="article-title">Honorable Mentions</h4>
          ...
          <div className="gallery">
            <div class="item"><img src="./images/LTTA.jpg" alt="Stanwyck in Ladies They Talk About"/></div>
            <div class="item"><img src="./images/baby-face.png" alt="Stanwyck in Babyface"/></div>
            <div class="item"><img src="./images/night-nurse.jpg" alt="Stanwyck in Night Nurse"/></div>

            <div class="item"><img src="./images/double-indemnity.jpg" alt="Stanwyck in Double Indemnity"/></div>
            <div class="item"><img src="./images/barbara-stanwyck-stage.jpeg" alt="Stanwyck in a theatre play"/></div>
          </div>
          ...
          <article className="during-postcode">
            <h4 className="article-title">During & Post Code</h4>
            ...
            {/* <div className="gallery">
              <img src="./images/wrong-number.jpeg" alt="Stanwyck in Double Indemnity" className="photo-reference"/>
              <img src="./images/stella-dallas-2.jpg" alt="Stanwyck in a theatre play" className="photo-reference"/>
              <img src="./images/annie-oakley.jpg" alt="Stanwyck in a theatre play" className="photo-reference"/>
              <img src="./images/the-lady-eve.jpg" alt="Stanwyck in a theatre play" className="photo-reference"/>
              <img src="./images/thorn-birds.jpg" alt="Stanwyck in a theatre play" className="photo-reference"/>
              <img src="./images/ball-of-fire.jpg" alt="Stanwyck in a theatre play" className="photo-reference"/>
              <img src="./images/big-valley.jpg" alt="Stanwyck in a theatre play" className="photo-reference"/>
            </div> */}

            <article id="testimonials" className="quotes">
              <h3 className="quote">“The greatest natural actress of our time. One of the theater’s great potential actresses was embalmed in celluloid.”</h3>
