    ...
    return (
      <section id="early-life">
        ...
        <div className="story">
          ...
          {/* <img src="./images/barbara stanwyck young.jpg" alt="teenager stanwyck" className="photo-reference"/> */}
        </div>
